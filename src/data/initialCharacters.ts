...
export const INITIAL_CHARACTERS: CharacterInput[] = [
  ...
  },
  {
    name: 'Mizrak',
    faction: 'Church',
    description: 'Knight of the Order of Saint John and a major Nocturne ally.',
    wikiUrl: 'https://castlevania.fandom.com/wiki/Mizrak',
